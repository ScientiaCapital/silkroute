...
class BudgetSnapshotItem(BaseModel):
    """A single daily budget snapshot for a project."""
...
class BudgetSnapshotListResponse(BaseModel):
    """GET /budget/snapshots response."""

    snapshots: list[BudgetSnapshotItem]
    count: int
